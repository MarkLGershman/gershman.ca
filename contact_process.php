<?php
	...
	// wait a second to simulate some latency
usleep(500000);
$to = "MarkLGershman@yahoo.ca"; // set your email here
$author = "";
$email = "";
$comment = "";
$captcha = "";
...
if ($captcha!='7') {
	...
	$body="
	  	<table width='450' border='1px' bordercolor='#B6B6B6' align='center'  cellspacing='0' cellpadding='0' style='border:1px solid #B6B6B6; border-collapse:collapse; background-color:#FFF; margin-top:16px; margin-bottom:10px;'>
             <tr>
			 <td colspan='2' style='text-align:center; background-color:#619FCE; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#fff; font-weight:bold; padding:6px;''>CONTACT FORM:&nbsp;&nbsp;&nbsp;[&nbsp;$date1&nbsp;]</td>
			 </tr>
			 <tr>
